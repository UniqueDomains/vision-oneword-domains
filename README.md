# Available .VISION One-Word Domains (8,579)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C583%20rows-8250df">
...
Daily-updated dataset of available and resale .vision one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 8,583 rows · **Live catalog:** 8,579 domains
...
- `vision.csv` — public CSV extract (8,583 rows)
- `vision.json` — public JSON extract (8,583 rows)
...
| like.vision       | available | $9.99     | $50.99        | 84             | 35     | 4      | name.com          |
| web.vision        | resell    | —         | —             | 72             | 61     | 3      | Porkbun LLC       |
| realestate.vision | premium   | $128.70   | $128.70       | —              | 40     | 11     | namecheap         |
| goon.vision       | available | $9.99     | $50.99        | 80             | 35     | 5      | name.com          |
...
| drive.vision      | premium   | $82.50    | $82.50        | 100            | 38     | 5      | name.com          |
| rank.vision       | available | $9.99     | $50.99        | 70             | 34     | 4      | name.com          |
| free.vision       | resell    | —         | —             | 88             | 57     | 4      | Sav.com, LLC      |
| cool.vision       | premium   | $250      | $250          | 76             | 38     | 4      | name.com          |
| cute.vision       | available | $9.99     | $50.99        | 82             | 32     | 4      | name.com          |
| data.vision       | resell    | —         | —             | 84             | 56     | 4      | Sav.com, LLC      |
...
| ----------------------- | ------------------------------------------------ |
| 8,583-row public sample | 8,579 live domains                               |
...
> Unique Domains. *Available .VISION One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
