...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C578%20rows-8250df">
...
> **Important:** this repository is a **public 8,578-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,096 domains** on the canonical page below.

**Public extract:** 8,578 rows · **Live catalog:** 5,622,096 domains
...
- `vision.csv` — public CSV extract (8,578 rows)
- `vision.json` — public JSON extract (8,578 rows)
...
| mail.vision       | resell    | —         | —             | 94             | 59     | 4      | Porkbun LLC       |
...
| email.vision      | resell    | —         | —             | 106            | 57     | 6      | Spaceship, Inc.   |
...
| ----------------------- | ------------------------------------------------ |
| 8,578-row public sample | 5,622,096 live domains                           |
...
> Unique Domains. *Available .VISION One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
