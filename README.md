...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C579%20rows-8250df">
...
**Public extract:** 8,579 rows · **Live catalog:** 8,579 domains
...
- `vision.csv` — public CSV extract (8,579 rows)
- `vision.json` — public JSON extract (8,579 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,579-row public sample | 8,579 live domains                               |
...
> Unique Domains. *Available .VISION One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
